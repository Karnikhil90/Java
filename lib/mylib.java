 ...
 * mylib
 */
public class mylib extends SysInput {
    public int[] range(int start, int limit, int update) {
        if (update <= 0)
    ...
    public int[] range(int start, int limit) {
    ...
    public boolean in(int[] array, int elemet) {
    ...
    public boolean in(int[] array, int[] secondaryArray) {
